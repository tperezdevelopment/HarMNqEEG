...
for i=1:size(pathnames,2)
    try
        ...
        if typeLog(2)==1
            ...
            %% Save the Harmonized Raw Cross-Spectra
            dsetname = 'Harmonized_Raw_Cross_Spectra'; dtype='Hermitian';
            ...
            if ~isempty(reRefBatch)
                %% Save the Harmonized Z-scores Cross-Spectra
                dsetname = 'Harmonized_Z_scores_Cross_Spectra'; dtype='Hermitian';
