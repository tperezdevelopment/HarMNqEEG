...
switch fileformat
  ...
  case 'afni'
    ...
    elseif contains(filename, 'TTatlas+tlrc')
      ...
      error('no information about the atlas labels is available');
    end
      ...
      if ~isprobabilistic
        ...
        for i = 1:nlabel
          ...
          if ~isempty(sel)
            ...
            warning('the value %d does not have a label according to the ATLAS_LABEL_TABLE and will be discarded', ulabel(i));
          end
        end
  ...
  case 'wfu'
    ...
    if exist(filename2, 'file')
      ...
      warning('cannot locate %s, making default tissue labels', filename2);
