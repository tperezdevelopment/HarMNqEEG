...
| <strong>Harmonized Raw Log-Spectra</strong>                                 | 2D Spectral Matrix   | Nc x Nf      | Same as the “Raw Log-Spectra” after harmonization to account for the batch effect.                                                                                                                                                                                                      | 
...
| <strong>Harmonized Z-scores Log Spectra </strong>                           | 2D Spectral Matrix   | Nc x Nf      | Same as the “Z-scores Log Spectra” for the harmonized Raw Log-Spectra.                                                                                                                                                                                                                  | 
...
| <strong>FFT_coefs</strong>                                                  | 3D Complex Matrix    | Nc x Nc x Ne | Complex matrix of FFT coefficients of the EEG data (stored for possible needed further processing for calculating the cross-spectral matrix, like regularization algorithms in case of ill-conditioning).                                                                               | 
