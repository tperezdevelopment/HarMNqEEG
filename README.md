...
| <strong>Harmonized_Raw_Log_Spectra</strong>      | 2D Spectral Matrix   | Nc x Nf      | Same as the Raw Log-Spectra after harmonization to account for the batch effect.                                                                                                                                                   | 
...
| <strong>Harmonized_Raw_Cross_Spectra_in_Tangent_Space</strong>         | 3D Hermitian Tensor  | Nc x Nc x Nf | Same as the <strong>Raw Cross-Spectra in Tangent Space</strong>, after harmonization to account for the batch effect.                                                                                                                                                                   | 
| <strong>Z_scores_of_Cross_Spectra_in_Tangent_Space</strong>            | 3D Hermitian Tensor  | Nc x Nc x Nf | It is the Z-scores of the <strong>Raw Cross-Spectra in Tangent Space</strong>.                                                                                                                                                                                                          | 
