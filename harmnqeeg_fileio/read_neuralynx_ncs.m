...
if ~isMexv6 && ~isMexv3
  ...
  warning('once', msgId);
  warning(msgId, 'reading Neuralynx CSC files is faster if you install the MATLAB importer mex files, see http://neuralynx.com/research_software/file_converters_and_utilities/ or https://www.urut.ch/new/serendipity/index.php?/pages/nlxtomatlab.html');
end
...
if NRecords>0
  ...
  gapCorrectedTimeStampPerSample =  mean(d(d<maxJump), 'omitnan')/512; %% Changed by tperezdevelopment fro nanmean
